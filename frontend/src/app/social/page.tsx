    ...
    <div className="bg-gradient-to-r from-[#F0F4FF] via-[#6EC6FF] to-[#1E3A8A] text-white min-h-screen">
      ...
      <section className="flex flex-row items-center justify-between h-screen px-16">
        ...
        <div className="w-1/2 text-left">
          ...
          <p className="mt-4 text-2xl text-[#000000] font-semibold">
            Stay connected with live social updates, events, and discussions.
          </p>
        </div>
        
        {/* Right Side - Animated Image (Smaller) */}
        <motion.div 
          className="w-1/4 flex justify-end"  // Adjusted width for a smaller image
      ...
      >
        ...
        <button className="mt-6 bg-[#1E3A8A] hover:bg-[#102A6B] px-6 py-3 rounded-lg text-lg shadow-lg">
          Join Now
        </button>
      </motion.section>
